...
public class TA1_Trab5_1_Dessaturacao implements PlugIn, DialogListener {
...
//		ImageProcessor processorBackup = imgBackup.getProcessor();
	...
	public int[] dessaturate(int[] pixel, float dessaturacao) {
		...
		//System.out.println("Dessaturated value: avg(%.2f), R%d G%d B%d".formatted(avg, pixel[0], pixel[1], pixel[2]));
		return pixel;
	}
}